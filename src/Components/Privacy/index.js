                    ...
                    <Grid container spacing={1} className="map flex justify-center">
                        <Grid item lg={9} md={9} sm={12} xs={12} className="privacy">
                            <div class="max-w-4xl mx-auto px-4 py-8">
                                ...
                                <p class="mb-4">We use this information for the purpose of processing orders, communicating with you, improving our products and services, and sending promotional materials and updates if you have opted to receive them.</p>

                                <h3 class="text-lg font-bold mb-2">Cookies and Log Files</h3>
                                <p class="mb-4">Shaharyar Traders uses cookies to store information about visitors' preferences, record user-specific information on which pages the user accesses or visits, and customize web page content based on visitors' browser type or other information that the visitor sends via their browser.</p>
                                <p class="mb-4">Log files are also utilized to track actions occurring on the website and gather demographic information. This information is not linked to any personally identifiable information.</p>

                                <h3 class="text-lg font-bold mb-2">Data Security</h3>
                                <p class="mb-4">Shaharyar Traders takes appropriate measures to safeguard the security of your personal information against unauthorized access, alteration, disclosure, or destruction. However, no method of transmission over the Internet or electronic storage is 100% secure, and we cannot guarantee absolute security.</p>

                                <h3 class="text-lg font-bold mb-2">Third-Party Disclosure</h3>
                                <p class="mb-4">Shaharyar Traders does not sell, trade, or otherwise transfer your personally identifiable information to outside parties. This does not include trusted third parties who assist us in operating our website, conducting our business, or servicing you, as long as those parties agree to keep this information confidential.</p>
